...
// inline converters
const toBool = (v: string | undefined | null, def = false) =>
  v == null ? def : ['true', '1', 'yes', 'on'].includes(v.toLowerCase());
...
export const config = {
  ...
  multerMaxFileSize: toInt(process.env.MULTER_MAX_FILE_SIZE, 2 * 1024 * 1024),

  // ─── Password Reset Configuration ────────────
  resetMaxAttempts: toInt(
    isTest
